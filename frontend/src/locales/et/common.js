...
const TRANSLATIONS = {
  ...
  "agent": {
    ...
    "settings": {
      ...
      "clarifying-questions": {
        ...
        "beta-badge": "BEETA",
        "description": "Kui funktsioon on lubatud, võivad agentid peatuda ja esitada lühikesi selgitavaid küsimusi, kui teie palumine on ebaselge.",
        "max-per-turn": {
          "title": "Maximaalne küsimuste arv ühes voorus",
          "description": "Kuivõrd küsimusi vahendaja võib ühe uuringu käigus esitada."
        }
      }
    }
  },
  ...
  "chat_window": {
    ...
    "memories": {
      "title": "Mälestused",
      "empty": "Hetkel pole veel mälestusi. Kui sa chatbotiga rohkem interakteerud, siis mälestused hakkavad täituma.",
      "empty_cta": "loo uus mälestus",
      "tab_workspace": "Tööruum",
      "tab_global": "Globaalne",
      "toggle": {
        "label": "Aktiveeri isikupärastamine",
        "description": "Lase oma assistendil meeles pidada fakte sinust või sellest tööruumist ning kasutada neid vestluses."
      },
      "auto_extraction": {
      ...
      "modal": {
        ...
        "create_description": "Mõtted peaksid olema lühikesed ja selged. Näiteks: \"Kasutaja eelistab Pythoni JavaScripti ees\".",
        "edit_description": "Päivitage selle andmealade sisu.",
        "label": "Mälestus",
        "placeholder": "Näiteks kasutaja nimi on Joe, kasutaja töötab ettevõttes AnythingLLM jne.",
        "create": "Loo",
        "save": "Salvesta",
        "cancel": "Katkuda\nTühista"
      }
    ...
    "stt_mic_denied": "Ei suudet mikrofoni kasutada. Palun andke lubadus ja proovige uuesti.",
  ...
  "scheduledJobs": {
    ...
    "description": "Loo korduvad AI-ülesanded, mis töötavad eeldatud ajakavaga. Iga ülesanne käitab promp, kasutades valikuvõimalusega tööriistu, ja salvestab tulemuse kontrollimiseks.",
    "newJob": "Uus töö",
    "loading": "Laadimine...",
    ...
    "confirmDelete": "Kas olete kindel, et soovite seda planeeritud tööd kustutada?",
    "toast": {
    ...
    "modal": {
      ...
      "promptLabel": "Järgmis",
      "promptPlaceholder": "Juhend, mis käsitleb programmi käivitamist iga kord, kui seda kasutatakse...",
      ...
      "toolsDescription": "Valige välja need agenti vahendid, mida see töö saab kasutada. Kui ühtki vahendit ei ole valitud, siis töö toimub ilma vahenditeta.",
      "toolsSearch": "otsing",
      "toolsNoResults": "Midagi sellist ei ole",
      "required": "Nõutav",
      "requiredFieldsBanner": "Palun täitke kõik vajalikud väljad, et töö avaldamine oleks võimalik.",
      "cancel": "Katkuda",
      "saving": "Säästmine...",
    ...
    "builder": {
      "fallbackWarning": "See väljend ei ole võimalik muuta visuaalselt. Valige \"Custom\" režiim, et seda säilitada, või muutke allolevaid elemente, et seda asendada.",
      "run": "Jooksa",
      "frequency": {
        "minute": "iga minut",
        "hour": "iga tunn",
  ...
  "model-router": {
    "title": "Mudelid",
    "description": "Mudelrouterid võimaldavad teil määrata reegleid, et automaatselt suunata vestlusvihtlemise teated erinevatele suurte keelemudelitele (LLM) ja mudelitele, lähtudes konkreetsetest tingimustest.",
    "table": {
      "name": "Nimi",
    ...
    "empty-description": "Hetkel pole mõeldud ruuterid konfigureeritud. Loomistage üks, et alustada.",
    "new-router-button": "Uus ruuter",
    "delete-confirm": "Kas olete kindel, et soovite seadme {{name}} kustutada?\nSee kustutab kõik selle reeglid ja lõhub ära kõik selle abil kasutatavad tööruumid.\n\nSee tegevus on pööratav.",
    ...
    "new-router": {
      ...
      "fallback-description": "Kasutatakse, kui pole leitud sobivat reeglit. Samuti kasutatakse suurte keelemudelite (LLM) klassifitseerimisreeglite hindamiseks.",
      "cooldown-label": "Vaikumise aeg (sekundites)",
      "cooldown-help": "Kuida kaua marsruuti valiku andmed säiliks pärast reeglite uuesti hindamist. Seadke väärtusele 0, et kustutada säilitamine.",
      "name-required": "Nimi on vajalik.",
      "fallback-required": "Peamine pakkujaga ja mudeliga peab olema kokkulepe.",
      "cancel": "Katkuda\nTühista",
      "create": "Loo reiting"
    },
    "edit-router": {
    ...
    "rules": {
      ...
      "description": "Määrake reeglid, mis määravad, millised suhtluse teated lähevad konkreetsetele teenustele ja mudelitele ning millisel viisil.",
      ...
      "empty-description": "Lisage reegel, mis määrab, et vestlemisvihtide saadetakse konkreetsetele teenustele ja mudelitele.",
      "new-rule-button": "Uus reegel",
      "calculated-section-label": "Arvutatud reeglid – hindatakse esmalt, prioriteedi järgi",
      "llm-section-label": "LLM reeglid – hinnatakse eraldi, kui ükski arvutatud reegel ei sobi",
      "llm-rule-body": "Vormista <desc>\"{{description}}\"</desc> ning seejärel suunata selle <route>{{route}}</route> poole",
      "calculated-no-conditions": "Ei ole tingimusi – marsruut <route>{{route}}</route>",
      "calculated-single-condition": "Kui <prop> on {{property}} ja </prop> on {{comparator}}, siis suunata <val> \"{{value}}\" ning </val> ​​suunata ​​<route> ​​ja ​​{{route}} ​​suunata ​​</route>",
      "calculated-multi-condition": "Kui {{quantifier}} on <cond> ja {{conditions}} on </cond>, siis reisi suunaga <route> ja {{route}} on </route>",
    ...
    "rule-form": {
      ...
      "conditions-incomplete": "Võtte {{index}} on mittekohane — täitke omand, võrdleja ja väärtus.",
      "match-description-label": "Mängu kirjeldus",
      "match-description-placeholder": "Näiteks kasutaja küsib seaduslikest küsimustest, lepingutest või nõuetele vastamisest.",
      "match-description-help": "Kirjelda olukorda, millal see reegel peaks rakenduma. See hinnatakse teie suurmõistega, et kindlaks teha, kas seda tuleks kasutada.",
      "route-to-label": "Teenusepakkaja ja mudeli leevastus",
      "route-to-description": "Kui see reegel on kehtiv, kasutage seda teenusepakkaja/mudelit.",
      "cancel": "Katkuda\nTühista",
      "saving": "Säästmine...",
      ...
      "type-calculated-description": "Võrdleme sõnemeid nende atribuutide järgi, nagu sisu, tokenite arv või päeva kellaaeg.",
      "type-llm-label": "LLM – klassifitseeritud",
      "type-llm-description": "Kasutage suurte keelemudelite (LLM) abil, et klassifitseerida sõnum, kasutades selleks teavet, mida te pakute.",
      ...
      "help-contains": "Komatähistega loend – vastab, kui küsimuses on olemas ükski neist väärtustest (suure- või väikestekirjadest olenemata).",
      "help-matches": "Regex-i muster. Kasutage `/muster/flagid`, et määrata kirjastuse tundlikkus (väärtus vaikimisi on kirjastuse tundlikkus).",
      "bool-true": "Väga tõsi",
      "bool-false": "Vale"
    },
    "provider-picker": {
      ...
      "setup-credentials": "Sisestage vajalikud andmed, et kasutada {{name}} kui reitingu sihte.",
      "cancel": "Katkuda\nTühista",
    ...
    "router-selection": {
      ...
      "no-routers-prefix-settings": "Hetkel pole veel konfigureeritud ühtegi režiisi.",
      "no-routers-prefix-workspace": "Ei ole konfigureeritud mitte ühtegi režiisi.",
      ...
      "no-routers-chat": "Ei ole konfigureeritud mitte ühtegi ruutrit. Loomitage uus ruuter seadetes > AI pakettide seadistustes > Mudeli ruuter.",
    ...
    "chat": {
      ...
      "routed-to-rule": "Saadetakse <route>{{model}}</route> kaudu <rule>{{ruleTitle}}</rule>"
    }
  },
  "defaultSystemPrompt": {
    "title": null,
