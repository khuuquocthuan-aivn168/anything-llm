...
const TRANSLATIONS = {
  ...
  "chat_window": {
    ...
    "memories": {
      "title": "Amintiri",
      "empty": "Până acum, nu există nicio amintire. După ce interacționați mai mult cu chatbot-ul, veți începe să aveți mai multe amintiri.",
      "empty_cta": "crează o nouă amintire",
      "tab_workspace": "Spațiu de lucru",
      "tab_global": "Global",
      "toggle": {
        "label": "Activează personalizarea",
        "description": "Permite-i asistentului tău să reamintească informații despre tine sau despre acest spațiu de lucru și să le folosească în conversații."
      },
      "auto_extraction": {
        "label": "Amintiri automate",
        "description": "Permite-i asistentului să creeze automat amintiri în fundal."
      },
      "menu": {
        "edit": "Editează",
        "delete": "Șterge",
      ...
      "modal": {
        ...
        "create_description": "Amintirile ar trebui să fie formulate într-un singur enunț, clar și concis. De exemplu: „Utilizatorul preferă Python față de JavaScript”.",
        "edit_description": "Actualizați conținutul acestui memorie.",
        "label": "Memorie",
        "placeholder": "De exemplu, numele utilizatorului este Joe, utilizatorul lucrează cu AnythingLLM, etc.",
        "create": "Creați",
        "save": "Salvați",
        "cancel": "Anula"
      }
    ...
    "stt_mic_denied": "Nu am putut accesa microfonul. Vă rugăm să acordați permisiunea și să încercați din nou.",
  ...
  "agent": {
    ...
    "settings": {
      ...
      "clarifying-questions": {
        "title": "Permite agentului să pună întrebări suplimentare pentru a clarifica anumite aspecte.",
        "beta-badge": "Versiune de test",
        "description": "Când este activată, agenții pot întrerupe discuția pentru a pune întrebări scurte și clare, dacă solicitarea dumneavoastră este ambiguă.",
        "max-per-turn": {
          "title": "Numărul maxim de întrebări per tur",
          "description": "Câte întrebări suplimentare poate adresa agentul în cadrul unui singur sondaj."
        }
      }
    }
  },
  ...
  "scheduledJobs": {
    ...
    "enableNotifications": "Activați notificările din browser pentru rezultatele căutării de locuri de muncă.",
    "description": "Creați sarcini AI repetitive, care rulează conform unui program. Fiecare sarcină execută un prompt, folosind opțional anumite instrumente, și salvează rezultatul pentru a fi revizuit ulterior.",
    ...
    "confirmDelete": "Sunteți sigur că doriți să eliminați această sarcină programată?",
    "toast": {
      ...
      "triggerSkipped": "Procesul de licitație pentru acest proiect este deja în desfășurare.",
    ...
    "modal": {
      ...
      "toolsDescription": "Selectați instrumentele disponibile pentru acest job. Dacă niciun instrument nu este selectat, job-ul va rula fără a utiliza niciun instrument.",
      "toolsSearch": "Caută",
      "toolsNoResults": "Nu există unelte potrivite.",
      "required": "Necesare",
      "requiredFieldsBanner": "Vă rugăm să completați toate câmpurile obligatorii pentru a crea o ofertă de loc de muncă.",
      "cancel": "Anula",
      "saving": "Economisire...",
    ...
    "builder": {
      "fallbackWarning": "Această expresie nu poate fi modificată vizual. Selectați \"Personalizat\" pentru a o păstra, sau modificați orice element de mai jos pentru a o suprascrie.",
      "run": "Alătura",
      "frequency": {
  ...
  "model-router": {
    ...
    "description": "Router-ele de model vă permit să definiți reguli pentru a direcționa automat mesajele de chat către diferiți furnizori și modele de LLM, în funcție de anumite condiții.",
    "table": {
      "name": "Nume",
    ...
    "empty-description": "Momentan, nu există routere configurate. Creați unul pentru a începe.",
    "new-router-button": "Router nou",
    "delete-confirm": "Sunteți sigur că doriți să ștergeți routerul \"{{name}}\"?\nAceasta va elimina toate regulile sale și va deconecta orice spațiu de lucru care îl utilizează.\n\nAceastă acțiune este ireversibilă.",
    ...
    "new-router": {
      ...
      "fallback-description": "Utilizat atunci când nu există nicio regulă de rutare care să se potrivească. De asemenea, este folosit pentru a evalua regulile clasificate de modelele lingvistice mari (LLM).",
      "cooldown-label": "Perioada de răcire a cache-ului (secunde)",
      "cooldown-help": "Cât timp este stocată în memorie decizia de rutare înainte de a fi reevaluată? Setarea la 0 dezactivează stocarea în memorie.",
      "name-required": "Numele este obligatoriu.",
      "fallback-required": "Este necesară identificarea furnizorului principal și a modelului specific.",
      "cancel": "Anula",
    ...
    "rules": {
      ...
      "description": "Stabiliți regulile care determină momentul și modul în care mesajele din chat sunt trimise către furnizori și modele specifici.",
      ...
      "empty-description": "Adăugați o regulă pentru a direcționa mesajele de chat către furnizori și modele specifice.",
      "new-rule-button": "Nouă regulă",
      "calculated-section-label": "Reguli calculate – evaluatează-le în ordine de prioritate",
      "llm-section-label": "Regulile LLM – evaluatează rezultatul ca un lot, dacă nicio regulă calculată nu se potrivește",
      "llm-rule-body": "Executați operațiunea <desc>\"{{description}}\"</desc> și apoi direcționați rezultatul către <route>{{route}}</route>",
      "calculated-no-conditions": "Fără condiții – traseu către <route> {{route}} </route>",
      "calculated-single-condition": "Dacă <prop>{{property}}</prop> {{comparator}} <val>\"{{value}}\"</val> atunci, direcționează către <route>{{route}}</route>",
      "calculated-multi-condition": "Dacă {{quantifier}} din <cond>{{conditions}}</cond> este adevărat, atunci traseul este către <route>{{route}}</route>",
    ...
    "rule-form": {
      ...
      "conditions-incomplete": "Condiția {{index}} este necompletă — completați proprietatea, comparatorul și valoarea.",
      "match-description-label": "Descrierea meciului",
      "match-description-placeholder": "De exemplu, utilizatorul solicită informații despre aspecte juridice, contracte sau conformitate.",
      "match-description-help": "Descrieți situația în care doriți ca această regulă să se aplice. Aceasta este evaluată de modelul dumneavoastră lingvistic pentru a determina dacă ar trebui utilizată.",
      "route-to-label": "Calea către furnizor și modelul de funcționare",
      "route-to-description": "Când această regulă se potrivește, utilizați acest furnizor/model.",
      "cancel": "Anula",
      "saving": "Economisire...",
      ...
      "type-calculated-description": "Potriviți în funcție de proprietățile mesajelor, cum ar fi conținutul, numărul de token-uri sau ora din zi.",
      "type-llm-label": "Clasificare LLM",
      "type-llm-description": "Utilizați un model de limbaj pentru a clasifica mesajul, pe baza unei descrieri pe care o furnizați.",
      ...
      "placeholder-between-hour": "de exemplu, 9:17 (de la 9 dimineața până la 17:00)",
      ...
      "help-contains": "Listă separată prin virgulă — se potrivește dacă solicitarea conține oricare dintre valorile specificate (fără a ține cont de majuscule).",
      "help-matches": "Model de expresie regulată. Utilizați `/pattern/cu flag-uri pentru a specifica dacă trebuie sau nu să se țină cont de majuscule și minuscule (implicit, nu se ține cont de majuscule și minuscule).",
      "bool-true": "Corect",
      "bool-false": "Fals"
    },
    "provider-picker": {
      ...
      "setup-credentials": "Introduceți datele de autentificare necesare pentru a utiliza {{name}} ca destinație de rutare.",
      "cancel": "Anula",
      "save-settings": "Salvați setările",
      "toast-save-failed": "Nu a fost posibil să se salveze setările: {{error}}"
    },
    "router-selection": {
      ...
      "select-description": "Alege router-ul pe care dorești să-l folosești pentru acest spațiu de lucru.",
      "no-routers-chat": "Nu există routere configurate. Creați unul în secțiunea Setări > Furnizori de AI > Router de model.",
    ...
    "chat": {
      ...
      "routed-to-rule": "Trasează spre <route>{{model}}</route> prin intermediul <rule>{{ruleTitle}}</rule>"
    }
  },
  "defaultSystemPrompt": {
    "title": null,
