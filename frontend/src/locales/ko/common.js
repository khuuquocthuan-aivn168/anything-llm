...
const TRANSLATIONS = {
  ...
  "agent": {
    ...
    "settings": {
      ...
      "clarifying-questions": {
        ...
        "beta-badge": "베타",
        "description": "활성화되면, 에이전트는 요청이 모호할 경우 간단한 확인 질문을 할 수 있습니다.",
        "max-per-turn": {
          "title": "각 턴당 질문 횟수 제한",
          "description": "담당자가 단일 설문 조사에서 질문할 수 있는 질문의 수는 몇 개입니까?"
        }
      }
    }
  },
  ...
  "chat_window": {
    ...
    "memories": {
      "title": "추억",
      "empty": "현재까지 기억은 없습니다. 하지만 챗봇과 상호 작용하면 점차 기억이 채워질 것입니다.",
      "empty_cta": "새로운 기억을 만들다",
      "tab_workspace": "업무 공간",
      "tab_global": "글로벌",
      "toggle": {
        "label": "개인 맞춤 설정 활성화",
        "description": "조수에게 당신이나 이 업무 공간에 대한 정보를 기억하도록 하고, 대화에서 활용하도록 하세요."
      },
      "auto_extraction": {
        "label": "자동으로 기록된 기억",
      ...
      "modal": {
        "create_title": "기억 만들기",
        "edit_title": "메모리 편집",
        "create_description": "기억은 간결하고 명확한 문장으로 표현해야 합니다. 예: \"사용자는 JavaScript보다 Python을 선호합니다\"",
        "edit_description": "이 메모의 내용을 업데이트하세요.",
        "label": "기억",
        "placeholder": "예: 사용자의 이름은 조, 사용자는 AnythingLLM에서 근무, 등",
        "create": "만들다",
        "save": "저장",
        "cancel": "취소"
      }
    ...
    "stt_mic_denied": "마이크에 접근할 수 없습니다. 권한을 부여하고 다시 시도해 주십시오.",
  ...
  "model-router": {
    "title": "모델 라우터",
    "description": "모델 라우터는 특정 조건에 따라 채팅 메시지를 자동으로 다른 LLM 제공업체 및 모델로 전달하는 규칙을 정의할 수 있도록 합니다.",
    "table": {
      "name": "이름",
      "fallback": "대체",
      "rules": "규칙",
    ...
    "empty-description": "아직 라우터 모델은 설정되지 않았습니다. 시작하려면 하나를 설정하십시오.",
    "new-router-button": "새로운 라우터",
    "delete-confirm": "라우터 \"{{name}}\"을 삭제하시겠습니까?\n이 작업은 모든 규칙을 삭제하고 해당 라우터를 사용하는 모든 워크스페이스를 분리합니다.\n\n이 작업은 되돌릴 수 없습니다.",
    ...
    "new-router": {
      ...
      "fallback-description": "다음과 같은 경우에 사용됩니다. 특정 경로 규칙과 일치하는 규칙이 없을 때, LLM(대규모 언어 모델)에 의해 분류된 규칙을 평가하는 데에도 사용됩니다.",
      "cooldown-label": "캐시 쿨다운 (초)",
      "cooldown-help": "라우팅 결정이 규칙 재평가 전에 얼마나 오래 캐싱되는지 설정합니다. 0으로 설정하면 캐싱을 비활성화합니다.",
    ...
    "rules": {
      ...
      "description": "특정 제공업체 및 모델로 메시지가 전송되는 시기와 방법을 결정하는 규칙을 정의합니다.",
      "add-rule": "규칙 추가",
      ...
      "empty-description": "특정 제공업체 및 모델로 채팅 메시지를 라우팅하는 규칙을 추가합니다.",
      "new-rule-button": "새로운 규칙",
      "calculated-section-label": "계산된 규칙 – 우선 순위에 따라 평가",
      "llm-section-label": "LLM 규칙 — 계산된 규칙이 일치하는 경우 일괄적으로 평가",
      "llm-rule-body": "다음 단계는 <desc>\"{{description}}\"</desc>을 매칭한 후, <route>{{route}}</route>로 경로를 지정하는 것입니다.",
      "calculated-no-conditions": "특정 조건 없음 – <route> 경로로 이동",
      "calculated-single-condition": "만약 <prop> {{property}} </prop> {{comparator}} <val> \"{{value}}\" </val> 이면, <route> {{route}} </route>로 이동합니다.",
      "calculated-multi-condition": "만약 {{quantifier}} (태그 0)가 {{conditions}} (태그 1)인 경우, <route> (태그 2)로 이동합니다.",
    ...
    "rule-form": {
      ...
      "conditions-incomplete": "조건 {{index}}이 불완전합니다. 속성, 비교 연산자, 값을 채워주세요.",
      "match-description-label": "경기 설명",
      "match-description-placeholder": "예를 들어, 사용자가 법률, 계약, 또는 규정 준수에 대해 질문하는 경우",
      "match-description-help": "이 규칙이 적용되어야 하는 상황을 설명해주세요. LLM은 이를 평가하여 실제로 적용할지 여부를 결정합니다.",
      "route-to-label": "제공업체 및 모델 경로",
      "route-to-description": "이 규칙과 일치하는 경우, 이 제공업체/모델을 사용하십시오.",
      "cancel": "취소",
      "saving": "저축 중...",
      "update-rule": "업데이트 규칙",
      "create-rule": "규칙 생성",
      ...
      "type-calculated-description": "콘텐츠, 토큰 수, 또는 시간 등의 메시지 속성을 기준으로 매칭합니다.",
      "type-llm-label": "LLM 분류",
      "type-llm-description": "제공해 주신 설명에 따라 LLM을 사용하여 메시지를 분류합니다.",
      ...
      "help-contains": "쉼표로 구분된 목록 – 프롬프트에 지정된 값 중 하나라도 포함되면 일치합니다 (대소문자를 구분하지 않음).",
      "help-matches": "정규 표현 패턴. 대소문자를 구분하는 옵션(`/pattern/`)을 사용하거나 (기본값은 대소문자를 구분하지 않음) 구분하지 않도록 설정할 수 있습니다.",
      "bool-true": "진실",
      "bool-false": "거짓"
    },
    "provider-picker": {
      ...
      "setup-credentials": "{{name}}를 라우팅 대상으로 사용하기 위한 필요한 자격 증명을 입력하세요.",
      "cancel": "취소",
    ...
    "router-selection": {
      ...
      "no-routers-chat": "라우터가 구성되지 않았습니다. 설정 > AI 제공업체 > 모델 라우터에서 새 라우터를 만드세요.",
      "rule-count": "({{count}} 규칙)"
    },
    "metrics": {
