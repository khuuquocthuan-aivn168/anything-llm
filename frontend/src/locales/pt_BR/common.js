...
const TRANSLATIONS = {
  ...
  "agent": {
    ...
    "settings": {
      ...
      "clarifying-questions": {
        ...
        "description": "Quando ativado, os agentes podem fazer pausas para fazer perguntas curtas e esclarecedoras, caso a sua solicitação seja ambígua.",
        "max-per-turn": {
          "title": "Número máximo de perguntas por turno",
          "description": "Quantas perguntas de esclarecimento o agente pode fazer em uma única pesquisa."
        }
      }
    }
  },
  ...
  "chat_window": {
    ...
    "memories": {
      "title": "Memórias",
      "empty": "Até agora, não há lembranças. Após você interagir mais com o chatbot, novas lembranças serão criadas ou",
      "empty_cta": "criar uma nova memória",
      "tab_workspace": "Espaço de trabalho",
      "tab_global": "Global",
      "toggle": {
        "label": "Ativar a personalização",
        "description": "Permita que seu assistente lembre-se de fatos sobre você ou sobre este ambiente de trabalho e utilize essas informações em conversas."
      },
      "auto_extraction": {
        "label": "Memórias Automáticas",
        "description": "Peça ao seu assistente para criar automaticamente memórias em segundo plano."
      },
      "menu": {
        "edit": "Editar",
        "delete": "Excluir",
      ...
      "modal": {
        ...
        "create_description": "As memórias devem ser uma única declaração concisa. Exemplo: \"O usuário prefere Python em vez de JavaScript\".",
        "edit_description": "Atualize o conteúdo desta memória.",
        "label": "Memória",
        "placeholder": "por exemplo, o nome do usuário é Joe, o usuário trabalha com AnythingLLM, etc.",
        "create": "Criar",
        "save": "Salvar",
        "cancel": "Cancelar"
      }
    ...
    "stt_mic_denied": "Não foi possível acessar o microfone. Por favor, conceda permissão e tente novamente.",
  ...
  "scheduledJobs": {
    ...
    "enableNotifications": "Ative as notificações do navegador para resultados de emprego.",
    "description": "Crie tarefas de IA recorrentes que sejam executadas em um determinado horário. Cada tarefa executa um prompt com ferramentas opcionais e salva o resultado para revisão.",
    "newJob": "Novo emprego",
    "loading": "Carregando...",
    ...
    "modal": {
      ...
      "toolsDescription": "Selecione quais ferramentas do agente podem ser utilizadas nesta tarefa. Se nenhuma ferramenta for selecionada, a tarefa será executada sem o uso de nenhuma ferramenta.",
      "toolsSearch": "Pesquisar",
      "toolsNoResults": "Não foram encontradas ferramentas correspondentes.",
      "required": "Requerido",
      "requiredFieldsBanner": "Por favor, preencha todos os campos obrigatórios para criar o anúncio de emprego.",
      "cancel": "Cancelar",
      "saving": "Economizando...",
    ...
    "builder": {
      "fallbackWarning": "Esta expressão não pode ser editada visualmente. Se desejar mantê-la, selecione \"Personalizado\". Caso contrário, altere qualquer um dos campos abaixo para substituí-la.",
      "run": "Correr",
      "frequency": {
  ...
  "model-router": {
    ...
    "description": "Os roteadores de modelo permitem que você defina regras para rotear automaticamente mensagens de bate-papo para diferentes provedores e modelos de LLM com base em condições específicas.",
    "table": {
      "name": "Nome",
    ...
    "new-router": {
      ...
      "fallback-description": "Utilizado quando nenhuma regra de roteamento corresponde. Também utilizado para avaliar regras classificadas por modelos de linguagem.",
      "cooldown-label": "Tempo de resfriamento do cache (segundos)",
      "cooldown-help": "Por quanto tempo a decisão de roteamento é armazenada em cache antes de reavaliar as regras. Defina como 0 para desativar o cache.",
      "name-required": "O nome é obrigatório.",
      "fallback-required": "É necessário indicar o principal fornecedor e o modelo.",
      "cancel": "Cancelar",
    ...
    "rules": {
      ...
      "description": "Defina as regras que determinam quando e como as mensagens de chat são enviadas a provedores e modelos específicos.",
      ...
      "empty-description": "Adicione uma regra para direcionar as mensagens de chat para provedores e modelos específicos.",
      "new-rule-button": "Nova Regra",
      "calculated-section-label": "Regras calculadas – avaliadas primeiramente, em ordem de prioridade",
      "llm-section-label": "Regras LLM – avaliadas em lote se nenhuma regra calculada corresponder",
      "llm-rule-body": "Execute a ação <desc>\"{{description}}\"</desc> e, em seguida, direcione para <route>{{route}}</route>",
      "calculated-no-conditions": "Sem condições — rota para <route>{{route}}</route>",
      "calculated-single-condition": "Se <prop>{{property}}</prop> {{comparator}} <val>\"{{value}}\"</val> então, direcione para <route>{{route}}</route>",
      "calculated-multi-condition": "Se a condição {{quantifier}} em <cond>{{conditions}}</cond> for verdadeira, então seguir para <route>{{route}}</route>",
    ...
    "rule-form": {
      ...
      "conditions-incomplete": "A condição {{index}} está incompleta — preencha com a propriedade, o comparador e o valor.",
      "match-description-label": "Descrição da partida",
      "match-description-placeholder": "por exemplo, o usuário está perguntando sobre tópicos legais, contratos ou conformidade.",
      "match-description-help": "Descreva a situação em que você deseja que esta regra seja aplicada. Isso será avaliado pelo seu modelo de linguagem para determinar se deve ser utilizada.",
      "route-to-label": "Roteiro para o Fornecedor e Modelo",
      "route-to-description": "Quando esta regra se aplica, utilize este provedor/modelo.",
      "cancel": "Cancelar",
      "saving": "Economizando...",
      ...
      "type-calculated-description": "Compare os resultados com base em propriedades da mensagem, como conteúdo, número de tokens ou horário do dia.",
      "type-llm-label": "Classificação LLM",
      "type-llm-description": "Utilize um modelo de linguagem para classificar a mensagem com base na descrição que você fornecer.",
      ...
      "help-contains": "Lista separada por vírgulas — corresponde se a consulta contiver algum dos valores (sem diferenciar maiúsculas e minúsculas).",
      "help-matches": "Padrão de expressão regular. Use \"/padrão/\" e as opções apropriadas para diferenciar maiúsculas e minúsculas (o padrão é ignorar a diferença entre maiúsculas e minúsculas).",
      "bool-true": "Verdade",
      "bool-false": "Falso"
    },
    "provider-picker": {
      ...
      "setup-credentials": "Insira as credenciais necessárias para utilizar {{name}} como destino de roteamento.",
      "cancel": "Cancelar",
    ...
    "router-selection": {
      ...
      "no-routers-prefix-settings": "Ainda não foram configurados roteadores de teste.",
      "no-routers-prefix-workspace": "Não foram configurados roteadores padrão.",
      ...
      "select-description": "Selecione o roteador que você deseja utilizar para esta área de trabalho.",
      "no-routers-chat": "Sem roteadores configurados. Crie um em Configurações > Fornecedores de IA > Roteador de Modelo.",
    ...
    "chat": {
      ...
      "routed-to-rule": "Direcionado para <route>{{model}}</route> através de <rule>{{ruleTitle}}</rule>"
    }
  },
  "defaultSystemPrompt": {
    "title": null,
