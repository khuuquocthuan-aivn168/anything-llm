...
const TRANSLATIONS = {
  ...
  "agent": {
    ...
    "settings": {
      ...
      "clarifying-questions": {
        "title": "Permettre à l'agent de poser des questions pour clarifier les points.",
        "beta-badge": "Bêta",
        "description": "Lorsque cette fonctionnalité est activée, les agents peuvent faire des pauses pour poser des questions de clarification si votre demande est ambiguë.",
        "max-per-turn": {
          "title": "Nombre maximal de questions par tour",
          "description": "Combien de questions de clarification un agent peut poser lors d'une seule enquête ?"
        }
      }
    }
  },
  ...
  "chat_window": {
    ...
    "memories": {
      "title": "Souvenirs",
      "empty": "Pour l'instant, aucune donnée mémorisée. Cependant, à mesure que vous interagissez davantage avec le chatbot, de nouveaux souvenirs seront enregistrés.",
      "empty_cta": "créer un nouveau souvenir",
      "tab_workspace": "Espace de travail",
      "tab_global": "Global",
      "toggle": {
        "label": "Activer la personnalisation",
        "description": "Permettez à votre assistant de se souvenir d'informations sur vous ou sur cet espace de travail et de les utiliser lors de conversations."
      },
      "auto_extraction": {
        "label": "Souvenirs automatisés",
        "description": "Faites en sorte que votre assistant crée automatiquement des souvenirs en arrière-plan."
      },
      "menu": {
        "edit": "Modifier",
        "delete": "Supprimer",
      ...
      "modal": {
        ...
        "create_description": "Les souvenirs doivent être exprimés sous une seule et concise phrase. Par exemple : « L'utilisateur préfère Python à JavaScript ».",
        "edit_description": "Mettez à jour le contenu de cette mémoire.",
        "label": "Mémoire",
        "placeholder": "Par exemple, le nom de l'utilisateur est Joe, l'utilisateur travaille sur AnythingLLM, etc.",
        "create": "Créer",
        "save": "Enregistrer",
        "cancel": "Annuler"
      }
  ...
  "scheduledJobs": {
    ...
    "enableNotifications": "Activer les notifications du navigateur pour les résultats de recherche d'emploi.",
    "description": "Créez des tâches d'IA récurrentes qui s'exécutent selon un calendrier. Chaque tâche exécute une requête avec des outils optionnels et enregistre le résultat pour examen ultérieur.",
    ...
    "confirmDelete": "Êtes-vous certain de vouloir supprimer cette tâche planifiée ?",
    "toast": {
    ...
    "modal": {
      ...
      "toolsDescription": "Sélectionnez les outils d'agent que cette tâche peut utiliser. Si aucun outil n'est sélectionné, la tâche s'exécutera sans aucun outil.",
      "toolsSearch": "Rechercher",
      "toolsNoResults": "Aucun outil ne correspond",
      "required": "Nécessaire",
      "requiredFieldsBanner": "Veuillez remplir tous les champs obligatoires afin de créer l'annonce.",
      "cancel": "Annuler",
      "saving": "Économiser...",
    ...
    "builder": {
      "fallbackWarning": "Cette expression ne peut pas être modifiée visuellement. Pour la conserver, passez en mode \"Personnalisé\". Sinon, modifiez tout ce qui se trouve en dessous pour la remplacer.",
      "run": "Courir",
      "frequency": {
    ...
    "runHistory": {
      ...
      "emptySubtitle": "Exécutez la tâche immédiatement et consultez les résultats.",
  ...
  "model-router": {
    ...
    "description": "Les routeurs modèles vous permettent de définir des règles pour acheminer automatiquement les messages de chat vers différents fournisseurs et modèles de LLM, en fonction de conditions spécifiques.",
    "table": {
      "name": "Nom",
    ...
    "empty-description": "Aucun routeur n'est configuré pour le moment. Créez-en un pour commencer.",
    "new-router-button": "Nouveau routeur",
    "delete-confirm": "Êtes-vous certain de vouloir supprimer le routeur \"{{name}}\" ?\nCela supprimera toutes ses règles et déconnectera tous les espaces de travail qui l'utilisent.\n\nCette action est irréversible.",
    ...
    "new-router": {
      ...
      "fallback-description": "Utilisé lorsque aucune règle de routage ne correspond. Il est également utilisé pour évaluer les règles classifiées par un modèle de langage.",
      "cooldown-label": "Durée de recharge (secondes)",
      "cooldown-help": "Combien de temps la décision de routage est-elle mise en cache avant de réévaluer les règles ? Définissez cette valeur sur 0 pour désactiver la mise en cache.",
      "name-required": "Le nom est obligatoire.",
      "fallback-required": "Le fournisseur principal et le modèle sont obligatoires.",
      "cancel": "Annuler",
    ...
    "rules": {
      ...
      "description": "Définir les règles qui déterminent quand et comment les messages de chat sont envoyés à des fournisseurs et des modèles spécifiques.",
      "add-rule": "Ajouter une règle",
      "delete-confirm": "Supprimer la règle \"{{title}}\"?",
      "toast-delete-failed": "Impossible de supprimer la règle.",
      "toast-reorder-failed": "Erreur lors de la tentative de réappliquer les règles.",
      "no-rules": "Aucune règle établie pour le moment.",
      "empty-description": "Ajoutez une règle pour diriger automatiquement les messages de chat vers des fournisseurs et des modèles spécifiques.",
      "new-rule-button": "Nouvelle règle",
      "calculated-section-label": "Règles calculées – évaluées en priorité",
      "llm-section-label": "Règles LLM – évaluées par lots si aucune règle calculée ne correspond",
      "llm-rule-body": "Correspondance avec \"<desc>\" puis redirection vers \"<route>\"{{route}}\"</route>\"",
      "calculated-no-conditions": "Aucune condition – itinéraire vers <route>{{route}}</route>",
      "calculated-single-condition": "Si <prop>{{property}}</prop> {{comparator}} <val>\"{{value}}\"</val> alors, rediriger vers <route>{{route}}</route>",
      "calculated-multi-condition": "Si {{quantifier}} de <cond>{{conditions}}</cond> alors, suivre le chemin vers <route>{{route}}</route>",
    ...
    "rule-form": {
      ...
      "conditions-incomplete": "La condition {{index}} est incomplète — veuillez remplir les champs propriété, comparateur et valeur.",
      "match-description-label": "Description du match",
      "match-description-placeholder": "Par exemple, l'utilisateur pose des questions sur des sujets juridiques, des contrats ou la conformité.",
      "match-description-help": "Décrivez la situation dans laquelle vous souhaitez que cette règle s'applique. Votre modèle de langage évaluera cette description pour déterminer si elle doit être utilisée.",
      "route-to-label": "Itinéraire vers le prestataire et modèle",
      "route-to-description": "Lorsque cette règle s'applique, utilisez ce fournisseur/modèle.",
      "cancel": "Annuler",
      "saving": "Économiser...",
      ...
      "type-calculated-description": "Correspondance basée sur des propriétés du message, telles que le contenu, le nombre de tokens ou l'heure de la journée.",
      "type-llm-label": "Catégorisation LLM",
      "type-llm-description": "Utilisez un modèle de langage pour classer le message en fonction d'une description que vous fournissez.",
      ...
      "help-contains": "Liste séparée par des virgules — correspond si la requête contient l'une des valeurs (sans tenir compte de la casse).",
      "help-matches": "Modèle d'expression régulière. Utilisez `/pattern/ et les drapeaux appropriés pour tenir compte de la casse (par défaut, la casse n'est pas prise en compte).",
      "bool-true": "Vrai",
      "bool-false": "Faux"
    },
    "provider-picker": {
      ...
      "setup-credentials": "Entrez les informations nécessaires pour utiliser {{name}} comme destination de routage.",
      "cancel": "Annuler",
    ...
    "router-selection": {
      ...
      "select-description": "Choisissez le routeur à utiliser pour cet espace de travail.",
      "no-routers-chat": "Aucun routeur n'est configuré. Créez-en un dans les paramètres > Fournisseurs d'IA > Routeur de modèle.",
    ...
    "chat": {
      ...
      "routed-to-rule": "Dirigé vers <route>{{model}}</route> via <rule>{{ruleTitle}}</rule>"
    }
  },
  "defaultSystemPrompt": {
    "title": null,
