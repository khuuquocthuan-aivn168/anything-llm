...
const TRANSLATIONS = {
  ...
  "agent": {
    ...
    "settings": {
      ...
      "clarifying-questions": {
        "title": "允許經紀人提出確認性問題",
        "beta-badge": "測試版",
        "description": "啟用後，代理可以暫停，並向您提出簡短的澄清問題，以釐清您的指示。",
        "max-per-turn": {
          "title": "每回合可以提出的問題數量",
  ...
  "chat_window": {
    ...
    "memories": {
      "title": "回憶",
      "empty": "目前還沒有相關的回憶。當您與聊天機器人互動後，相關的回憶就會逐漸產生。",
      "empty_cta": "創造新的回憶",
      "tab_workspace": "工作空間",
      "tab_global": "全球",
      "toggle": {
        "label": "啟用個人化功能",
        "description": "讓您的助手能夠回憶關於您或這個工作空間的相關資訊，並在對話中使用這些資訊。"
      },
      "auto_extraction": {
        "label": "自動回憶",
      ...
      "modal": {
        "create_title": "建立回憶",
        "edit_title": "編輯記憶",
        "create_description": "回憶應該簡潔明瞭，用單一的陳述來表達。例如：「使用者更偏好 Python 語言，而非 JavaScript 語言」。",
  ...
  "scheduledJobs": {
    ...
    "description": "建立可重複執行的 AI 任務，並設定執行時間表。每個任務會執行一個指令，並可選地使用工具，然後將結果儲存以供後續檢閱。",
    "newJob": "新的工作",
    "loading": "載入中...",
    ...
    "modal": {
      ...
      "toolsLabel": "工具（可選）",
      "toolsDescription": "請選擇此工作可以使用的工具。如果沒有選擇任何工具，則工作將不使用任何工具。",
      "toolsSearch": "搜尋",
    ...
    "builder": {
      "fallbackWarning": "這個表達方式無法透過視覺編輯來修改。請選擇「自訂」選項來保留它，或修改以下內容以覆蓋它。",
      "run": "跑步",
      "frequency": {
        "minute": "每分鐘",
        "hour": "每小時",
  ...
  "model-router": {
    "title": "模型路由器",
    "description": "模型路由器讓您能夠定義規則，根據特定條件自動將聊天訊息路由到不同的 LLM 供應商和模型。",
    "table": {
      "name": "姓名",
      "fallback": "備用方案",
      "rules": "規則",
    ...
    "delete-confirm": "您確定要刪除路由器 \"{{name}}\" 嗎？\n這將會刪除所有相關規則，並斷開使用該路由器的所有工作空間。\n\n此操作不可撤銷。",
    ...
    "new-router": {
      ...
      "fallback-description": "當沒有任何路由規則符合時，也會使用此方法。此外，也可用於評估由大型語言模型（LLM）分類的規則。",
      "cooldown-label": "緩存冷卻時間 (秒)",
      "cooldown-help": "路由決策在重新評估規則之前，會被暫存多長時間？將此設定設為 0 則會停用暫存功能。",
    ...
    "rules": {
      ...
      "llm-rule-body": "執行 <desc>「{{description}}」</desc>，然後將其路由到 <route>{{route}}</route>",
      "calculated-no-conditions": "沒有任何限制 — 路線為 <route>{{route}}</route>",
      "calculated-single-condition": "如果符合 <prop>、{{property}}、</prop> 的條件，則前往 {{comparator}}、<val>、「{{value}}」、</val>，然後前往 <route>、{{route}}、</route>。",
      "calculated-multi-condition": "如果 {{quantifier}} 符合 <cond> 的條件，則將路線設定為 </cond>{{route}}</route>",
    ...
    "rule-form": {
      ...
      "conditions-incomplete": "條件 {{index}} 尚未完成 — 請填寫「屬性」、「比較器」和「值」。",
      "match-description-label": "比賽描述",
      "match-description-placeholder": "例如，使用者詢問的是法律相關議題、合約或合規性等方面",
      "match-description-help": "說明您希望此規則適用於哪些情況。您的 LLM 將評估這些情況，以判斷是否應該使用該規則。",
      ...
      "type-calculated-description": "根據訊息的屬性，例如內容、字數或發送時間，進行比對。",
      "type-llm-label": "LLM 類別",
      "type-llm-description": "利用大型語言模型，根據您提供的描述，對訊息進行分類。",
      ...
      "help-contains": "以逗號分隔的列表 — 如果提示包含任何這些值（不區分大小寫），則匹配。",
      "help-matches": "正規表示式模式。使用 `/模式/旗標` 進行大小寫區分 (預設為不區分大小寫)。",
      "bool-true": "正確",
      "bool-false": "錯誤"
    },
    "provider-picker": {
    ...
    "router-selection": {
      ...
      "no-routers-chat": "目前沒有設定任何路由器。請前往「設定」>「AI 提供者」>「模型路由器」處建立一個。",
      "rule-count": "({{count}} 規則)"
    },
    "metrics": {
    ...
    "chat": {
      ...
      "routed-to-rule": "經由 <route> {{model}} </route>，並通過 <rule> {{ruleTitle}} </rule> 進行。"
    }
  },
  "defaultSystemPrompt": {
    "title": null,
