...
const TRANSLATIONS = {
  ...
  "agent": {
    ...
    "settings": {
      ...
      "clarifying-questions": {
        ...
        "beta-badge": "BETA",
        "description": "Kad tas ir aktivizēts, aģenti var pārtraukt darbību, lai uzdotu īsas, skaidrotas jautājumus, ja jūsu lūdzes formulējums ir neprecīzs.",
        "max-per-turn": {
  ...
  "chat_window": {
    ...
    "memories": {
      "title": "Atgādinājumi",
      "empty": "Līdz šim nav atmiņu. Kad jūs vairāk iejiegsas ar šo chatbot, atmiņas automātiski sāks pieaugt.",
      "empty_cta": "izveidot jaunu atmiņu",
      "tab_workspace": "Darba vieta",
      "tab_global": "Vispārīgs",
      "toggle": {
        "label": "Ievērojiet personīgu pielāgošanu",
        "description": "Ļauj savam asistējam atgāstīt informāciju par Tevi vai šo darba vietu un izmantot šo informāciju sarunās."
      },
      "auto_extraction": {
      ...
      "modal": {
        ...
        "create_description": "Atgādinājumi jāizteicas kā vienots, skaidrs paziņojums. Piemēram: \"Izmantotājs dod priekšroku Python valodai, nevis JavaScript\".",
        "edit_description": "Atjaunini šī atmiņas saturu.",
        "label": "Atmiņa",
        "placeholder": "piemēram, lietotāja vārds ir Jo, lietotājs strādā AnythLLM, utt.",
        "create": "Izveidot",
        "save": "Saglabāt",
        "cancel": "Atcelt"
      }
    ...
    "stt_mic_denied": "Neizdevās piekļūt mikrofonam. Lūdzu, atļaujiet piekļaušanu un mēģiniet vēlreiz.",
  ...
  "scheduledJobs": {
    ...
    "enableNotifications": "Ievērojiet pārlūkprogrammā atgādinājumus par darbā pieņemšanas rezultātiem",
    "description": "Izveidot atkārtotas AI uzdevumus, kas tiek veiktas saskaņā ar noteiktu grafiku. Katrs uzdevums izmanto norādīto, kā arī var izmantot papildu rīkus, un rezultāts tiek saglabāts, lai to varētu pārskatīt.",
    ...
    "modal": {
      ...
      "promptPlaceholder": "Instrukcija, kas norāda, ka programmu jāizpilda katrā darbībā...",
      ...
      "toolsDescription": "Izvēlieties, kādas programmatūras rīkus šis darbs var izmantot. Ja neviens rīks nav izvēlēts, darbs tiks veikts bez jebkurām programmatūras rīkiem.",
      "toolsSearch": "Meklēšana",
      "toolsNoResults": "Nav atrasts neviens atbilstošs rīks.",
      "required": "Nepieciešams",
      "requiredFieldsBanner": "Lūdzu, aizpildiet visus obligātās laukus, lai izveidotu darbā.",
      "cancel": "Atcelt",
      "saving": "Ietaupīt...",
    ...
    "builder": {
      "fallbackWarning": "Šo izteikumu nevar redzami rediģēt. Izmantojiet \"Custom\" režīmu, lai to saglabātu, vai mainiet jebko zemāk, lai to pārvietotu.",
      "run": "Runāt",
      "frequency": {
        "minute": "katru minūti",
        "hour": "laika periodā",
  ...
  "model-router": {
    ...
    "description": "Modeli routeri ļauj definēt noteikumus, kas automātiski nosaka, kā sūtīt tērzēšanas ziņojus dažādiem LLM (liels valodu modeļi) sniedzējiem un modeļiem, pamatojoties uz noteiktiem nosacījumiem.",
    "table": {
      "name": "Vārds",
    ...
    "empty-description": "Vēl nav konfigurētas nekādas maršrutētāju modeļi. Izveidoiet vienu, lai sāktu.",
    "new-router-button": "Jauns maršrutētājs",
    "delete-confirm": "Vai jūs noteikti vēlaties dzēst routeri \"{{name}}\"?\nTas noņems visas tā esošās regulas un atslēgs visus darba vietas, kas to izmanto.\n\nŠī darbība ir neatgriezeniska.",
    ...
    "new-router": {
      ...
      "fallback-description": "Izmanto, kad nav atrast nekādu noteikumu, kas atbilst. Tāpat izmanto, lai novērtētu LLM (liels valodas modelis) klasificētos noteikumus.",
      "cooldown-label": "Pēcmaksas laiks (sekundes)",
      "cooldown-help": "Cik ilgi maršruta lēmums tiek saglabāts, pirms atjauninātas noteikumi. Iestatīšana uz 0 atspējo saglabāšanu.",
      "name-required": "Vajadzīgs ir vārds.",
      "fallback-required": "Neaizstājams pakalpojuma sniedzējs un attiecīgā modeļa nosaukums ir obligāts.",
      "cancel": "Atcelt",
    ...
    "rules": {
      ...
      "description": "Izveidot noteikumus, kas nosaka, kad un kā ziņojumi tiek nosūtīti konkrētiem pakalpojumu sniedzējiem un modeļiem.",
      ...
      "empty-description": "Ieviesiet noteikumu, lai sāktu sūtīt ziņojus no čata konkrētiem sniedzējiem un modeļiem.",
      "new-rule-button": "Jauna noteikums",
      "calculated-section-label": "Ierakstītās regulas – novērtējamas pirmā, prioritārajā secībā",
      "llm-section-label": "LLM noteikumi – novērtēti kā vienas reizes, ja neviens aprēķināts noteikums neatbilst",
      "llm-rule-body": "Izvēlēties <desc>\"{{description}}\"</desc> un pēc tam pāriet uz <route>{{route}}</route>",
      "calculated-no-conditions": "Bez ierobežojumiem – maršruta ceļš uz <route>{{route}}</route>",
      "calculated-single-condition": "Ja <prop> {{property}} </prop> {{comparator}} <val> \" {{value}} \" </val> tad pāriet uz <route> {{route}} </route>",
      "calculated-multi-condition": "Ja {{quantifier}} ir <cond> un {{conditions}} ir </cond>, tad maršruta ceļš ir uz <route> un {{route}} un </route>",
    ...
    "rule-form": {
      ...
      "conditions-incomplete": "Stāvoklis {{index}} ir nevis pilnīgs — norādiet īpašumu, salīdzinājumu un vērtību.",
      "match-description-label": "Spēles apraksts",
      "match-description-placeholder": "piemēram, lietotājs interesējas par juridiskām jautājumiem, līgumiem vai atbilstību normām",
      "match-description-help": "Aizstājiet situāciju, kad vēlaties, lai šis noteikums būtu piemērojams. Šo novērtēs jūsu mākslīgā intelektu, lai noskaidrotu, vai to vajadzētu izmantot.",
      "route-to-label": "Ceļš uz sniedzēju un modelis",
      "route-to-description": "Ja šis noteikums ir piemērojams, izmantojiet šo sniedzēju/modeli.",
      "cancel": "Atcelt",
      "saving": "Ietaupīt...",
      ...
      "type-calculated-description": "Izvēlieties sūtījumus, pamatojoties uz tā īpašībām, piemēram, satura, tokenu skaitu vai dienas laiku.",
      "type-llm-label": "LLM klasiificēts",
      "type-llm-description": "Izmantojiet lielu valodu modeli (LLM), lai klasificētu ziņojumu, ņemot vērā to, ko jūs sniegsiet.",
      ...
      "help-contains": "Saraksts, kas atdala komātām — atbilst, ja jautājumā ir iekļautas kāda no vērtībām (neievērojot apakšrakstus).",
      "help-matches": "RegEx shablon. Izmantojiet `/shablon/zīmīgus vārdus`, lai noteiktu atšķirību starp lielajiem un malajiem rakstiem (par apakšā ir atvērtā atšķirība).",
      "bool-true": "Patiesi",
    ...
    "provider-picker": {
      ...
      "setup-credentials": "Ievadiet nepieciešamos datus, lai izmantotu {{name}} kā maršruta mērķi.",
      "cancel": "Atcelt",
    ...
    "router-selection": {
      ...
      "select-description": "Izvēlieties, kuru routeru izmantot šim darba vietai.",
      "no-routers-chat": "Neizveidoti nekādi maršrutētāji. Izveidoiet vienu, izmantojot \"Iestatījumi > AI nodrošinātāji > Maršrutētāja modelis\".",
    ...
    "chat": {
      ...
      "routed-to-rule": "Aizvedēts pa <route>{{model}}</route> ceļu, izmantojot <rule>{{ruleTitle}}</rule>"
    }
  },
  "defaultSystemPrompt": {
    "title": null,
