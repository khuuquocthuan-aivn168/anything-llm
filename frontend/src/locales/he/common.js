...
const TRANSLATIONS = {
  ...
  "agent": {
    ...
    "settings": {
      ...
      "clarifying-questions": {
        ...
        "beta-badge": "בטא",
        "description": "כאשר הפונקציה מופעלת, ניתן לבקש מהנציגים לעצור ולשאול שאלות קצרות להבהרה, במקרה שההנחיה שלך אינה ברורה.",
        "max-per-turn": {
  ...
  "chat_window": {
    ...
    "memories": {
      "title": "זיכרונות",
      "empty": "עד כה, אין זיכרונות. לאחר שתתקשרו עם הצ'אטבוט, זיכרונות נוספים יתמלאו.",
      "empty_cta": "ליצור זיכרון חדש",
      "tab_workspace": "חלל עבודה",
      "tab_global": "גלובלי",
      "toggle": {
        "label": "אפשרות להתאים אישית",
        "description": "אפשר לאשתף את העוזר שלך במידע עלייך או על סביבת העבודה, ובכך להשתמש בו בשיחות."
      },
      "auto_extraction": {
        "label": "זיכרונות אוטומטיים",
        "description": "אפשר להגדיר את העוזר שלך ליצור תזכורות באופן אוטומטי ברקע."
      },
      "menu": {
        "edit": "עריכה",
        "delete": "מחיקה",
      ...
      "modal": {
        ...
        "create_description": "הזיכרונות צריכים להיות הצהרה אחת, תמציתית. לדוגמה: \"המשתמש מעדיף את Python על פני JavaScript\".",
        "edit_description": "עדכן את התוכן של הזיכרון הזה.",
        "label": "זיכרון",
        "placeholder": "לדוגמה, שם המשתמש הוא ג'ואי, המשתמש עובד על פלטפורמת AnythingLLM, וכן הלאה.",
        "create": "צור",
        "save": "שמור",
        "cancel": "בטל"
      }
  ...
  "model-router": {
    ...
    "description": "נתב מודל מאפשר לך להגדיר כללים כך שהודעות צ'אט יועברו באופן אוטומטי לספקי ומודלים שונים של מודלים של שפה, בהתאם לתנאים.",
    "table": {
      "name": "שם",
    ...
    "empty-description": "אין מכשירי רשת מוגדרים עדיין. יש להגדיר אחד כדי להתחיל.",
    "new-router-button": "ראוטר חדש",
    "delete-confirm": "האם אתה בטוח שאתה רוצה למחוק את הראוטר \"{{name}}\"?\nפעולה זו תסיר את כל הכללים שלה ותנתק כל סביבת עבודה המשתמשת בה.\n\nפעולה זו אינה ניתנת לבטל.",
    ...
    "new-router": {
      ...
      "fallback-description": "משמש כאשר אין כלל ניתוב התואם. משמש גם להערכת כללים שסווגו על ידי מודל שפה גדול (LLM).",
      "cooldown-label": "זמן קירור (שניות)",
      "cooldown-help": "כמה זמן החלטת המסלול נשמרת לפני הערכת החוקים מחדש. הגדרות ל-0 כדי לבטל את השמירה.",
    ...
    "rules": {
      ...
      "description": "הגדירו את הכללים שקובעים מתי וכיצד הודעות צ'אט מועברות לספקים ודגמים ספציפיים.",
      "add-rule": "הוסף כלל",
      ...
      "empty-description": "הוסף כלל שיגרום לניתוב הודעות צ'אט לספקים ומודלים ספציפיים.",
      "new-rule-button": "חוק חדש",
      "calculated-section-label": "כללים שנקבעו – נבדקו תחילה, בסדר עדיפויות.",
      "llm-section-label": "כללי LLM – נבדקים כקבוצה, אם אף אחד מהכללים שחושבו לא התאים.",
      "llm-rule-body": "בצע את הפעולה \"<desc>\"{{description}}\" \"</desc>\" ואז פנה ל-<route>{{route}}</route>",
      "calculated-no-conditions": "ללא תנאים – מסל הגעה ל<route>{{route}}</route>",
      "calculated-single-condition": "אם <prop> נמצא במיקום {{property}} וגם </prop> נמצא במיקום {{comparator}} וגם <val> נמצא במיקום {{value}} אז, יש להעביר את המסלול ל-<route> במיקום {{route}}",
      "calculated-multi-condition": "אם {{quantifier}} של <cond> נמצא ב{{conditions}} של </cond>, אז יש לכוון את המסלול ל<route> של {{route}} של </route>",
    ...
    "rule-form": {
      ...
      "conditions-incomplete": "התנאי {{index}} אינו שלם – יש למלא את השדה עבור המיקום, המשוואה והערך.",
      "match-description-label": "תיאור המשחק",
      "match-description-placeholder": "למשל, המשתמש שואל על נושאים משפטיים, חוזים או נושאים הקשורים לציות לחוק.",
      "match-description-help": "תארו את המצב שבו אתם רוצים שהכלל הזה יחול. ה-LLM שלכם ישמש כדי לקבוע אם יש להשתמש בו.",
      ...
      "type-calculated-description": "התאמה על סמך תכונות של ההודעה, כגון תוכן, מספר הטוקנים או שעת היום.",
      "type-llm-label": "קטגוריית LLM",
      "type-llm-description": "השתמש במודל שפה גדול (LLM) כדי לסווג את ההודעה על סמך תיאור שאתה מספק.",
      ...
      "help-contains": "רשימה המופרדת בפסיקים – תואמת אם השאילתה מכילה אחד מהערכים (ללא התחשבות בגודל האותיות).",
      "help-matches": "תבנית רגולרי. יש להשתמש ב-/pattern/ עם דגלים כדי להגדיר רגישות לאותיות (ברירת המחדל היא אי רגישות לאותיות).",
      "bool-true": "נכון",
      "bool-false": "לא נכון"
    },
    "provider-picker": {
      ...
      "setup-credentials": "הזן את הפרטים הנדרשים כדי להשתמש ב-{{name}} כמיקוד.",
      "cancel": "בטל",
    ...
    "router-selection": {
      ...
      "select-description": "בחר את הראוטר שתרצה להשתמש בו עבור אזור העבודה הזה.",
      "no-routers-chat": "אין מכשירי רשת מוגדרים. צרו אחד בתפריט \"הגדרות\" > \"ספקי בינה מלאכותית\" > \"מכשיר רשת\".",
    ...
    "chat": {
      ...
      "routed-to-rule": "נשלח דרך <route>{{model}}</route> באמצעות <rule>{{ruleTitle}}</rule>"
    }
  },
  "defaultSystemPrompt": {
    "title": null,
