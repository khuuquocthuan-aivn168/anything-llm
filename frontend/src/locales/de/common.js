...
const TRANSLATIONS = {
  ...
  "agent": {
    ...
    "settings": {
      ...
      "clarifying-questions": {
        "title": "Ermöglichen Sie dem Vertreter, Nachfragen zu stellen, um Unklarheiten zu beseitigen.",
        "beta-badge": "TESTVERSION",
        "description": "Wenn die Funktion aktiviert ist, können die Agenten eine kurze, klärende Frage stellen, falls Ihre Anfrage unklar ist.",
        "max-per-turn": {
          "title": "Maximale Anzahl an Fragen pro Zug",
          "description": "Wie viele Nachfragen darf der Mitarbeiter während einer einzelnen Befragung stellen?"
        }
      }
    }
  },
  ...
  "chat_window": {
    ...
    "memories": {
      "title": "Erinnerungen",
      "empty": "Bisher gibt es keine Erinnerungen. Wenn Sie jedoch mehr mit dem Chatbot interagieren, werden weitere Erinnerungen erstellt oder",
      "empty_cta": "erstellen Sie einen neuen Speicher",
      "tab_workspace": "Arbeitsbereich",
      "tab_global": "Global",
      "toggle": {
        "label": "Personalisierung aktivieren",
        "description": "Ermöglichen Sie Ihrem Assistenten, Informationen über Sie oder diesen Arbeitsbereich zu speichern und diese Informationen in Gesprächen zu verwenden."
      },
      "auto_extraction": {
        "label": "Automatische Erinnerungen",
        "description": "Lassen Sie Ihren Assistenten automatisch Erinnerungen erstellen, ohne dass Sie aktiv eingreifen müssen."
      },
      "menu": {
        "edit": "Bearbeiten",
        "delete": "Löschen",
      ...
      "modal": {
        ...
        "create_description": "Erinnerungen sollten eine einzelne, prägnante Aussage sein. Zum Beispiel: „Benutzer bevorzugt Python gegenüber JavaScript“",
        "edit_description": "Aktualisieren Sie den Inhalt dieses Speichers.",
        "label": "Gedächtnis",
        "placeholder": "z.B. Benutzername: Joe, Benutzer arbeitet an AnythingLLM, usw.",
        "create": "Erstellen",
        "save": "Speichern",
        "cancel": "Abbrechen"
      }
  ...
  "scheduledJobs": {
    ...
    "enableNotifications": "Aktivieren Sie Benachrichtigungen im Browser für Stellenangebote",
    "description": "Erstellen Sie wiederkehrende KI-Aufgaben, die zu einem bestimmten Zeitpunkt ausgeführt werden. Jede Aufgabe führt eine Anfrage aus, optional mit zusätzlichen Werkzeugen, und speichert das Ergebnis zur Überprüfung.",
    ...
    "confirmDelete": "Sind Sie sicher, dass Sie diesen geplanten Job löschen möchten?",
    "toast": {
    ...
    "modal": {
      ...
      "promptPlaceholder": "Die Anweisung, dass es bei jeder Ausführung erfolgen soll…",
      ...
      "toolsDescription": "Wählen Sie, welche Agenten-Tools für diese Aufgabe verwendet werden können. Wenn keine Tools ausgewählt sind, wird die Aufgabe ohne Verwendung von Tools ausgeführt.",
      "toolsSearch": "Suche",
      "toolsNoResults": "Keine der verfügbaren Werkzeuge passen",
      "required": "Erforderlich",
      "requiredFieldsBanner": "Bitte füllen Sie alle erforderlichen Felder aus, um die Stellenanzeige zu erstellen.",
      "cancel": "Abbrechen",
      "saving": "Sparen...",
    ...
    "builder": {
      "fallbackWarning": "Dieser Text kann nicht visuell bearbeitet werden. Verwenden Sie die Option \"Benutzerdefiniert\", um ihn beizubehalten, oder ändern Sie die entsprechenden Felder unten, um ihn zu überschreiben.",
      "run": "Laufen",
      "frequency": {
        "minute": "jede Minute",
        "hour": "pro Stunde",
    ...
    "runHistory": {
      ...
      "emptySubtitle": "Führen Sie die Aufgabe jetzt aus und überprüfen Sie die Ergebnisse.",
      "runNow": "Jetzt los!",
      "table": {
        "status": "Status",
        "started": "Angefangen",
  ...
  "model-router": {
    "title": "Modell-Router",
    "description": "Modellroutern ermöglichen es Ihnen, Regeln zu definieren, um Chat-Nachrichten automatisch an verschiedene LLM-Anbieter und -Modelle auf der Grundlage bestimmter Bedingungen weiterzuleiten.",
    "table": {
      "name": "Name",
    ...
    "empty-description": "Noch keine Router-Modelle konfiguriert. Erstellen Sie eines, um loszulegen.",
    "new-router-button": "Neuer Router",
    "delete-confirm": "Sind Sie sicher, dass Sie den Router \"{{name}}\" löschen möchten?\nDadurch werden alle seine Einstellungen und alle Arbeitsbereiche, die er verwendet, getrennt.\n\nDiese Aktion ist nicht rückgängig machbar.",
    ...
    "new-router": {
      ...
      "fallback-description": "Wird verwendet, wenn keine Routing-Regel übereinstimmt. Wird auch verwendet, um die von LLMs (Large Language Models) klassifizierten Regeln zu bewerten.",
      "cooldown-label": "Abkühlzeit (Sekunden)",
      "cooldown-help": "Wie lange eine Routing-Entscheidung zwischengespeichert wird, bevor die Regeln erneut überprüft werden. Auf 0 setzen, um das Zwischenspeichern zu deaktivieren.",
      "name-required": "Ein Name ist erforderlich.",
      "fallback-required": "Es werden ein Hauptanbieter und ein Modell erforderlich.",
      "cancel": "Abbrechen",
    ...
    "rules": {
      ...
      "description": "Definieren Sie die Regeln, die bestimmen, wann und wie Chat-Nachrichten bestimmten Anbietern und Modellen zugestellt werden.",
      ...
      "empty-description": "Fügen Sie eine Regel hinzu, um Chat-Nachrichten an bestimmte Anbieter und Modelle weiterzuleiten.",
      "new-rule-button": "Neue Regel",
      "calculated-section-label": "Berechnete Regeln – zuerst bewertet, in Prioritätsreihenfolge",
      "llm-section-label": "Regeln für LLM – werden als Batch ausgewertet, wenn keine der berechneten Regeln übereinstimmt",
      "llm-rule-body": "Vergleichen Sie <desc>\"{{description}}\"</desc>, und leiten Sie dann den Pfad zu <route>{{route}}</route> weiter.",
      "calculated-no-conditions": "Keine Bedingungen – Route zu <route>{{route}}</route>",
      "calculated-single-condition": "Wenn <prop>{{property}}</prop> {{comparator}} <val>\"{{value}}\"</val> der Fall ist, dann die Route zu <route>{{route}}</route> wählen.",
      "calculated-multi-condition": "Wenn {{quantifier}} von <cond>{{conditions}}</cond> stammt, dann wird die Route nach <route>{{route}}</route> festgelegt.",
    ...
    "rule-form": {
      ...
      "conditions-incomplete": "Der Zustand {{index}} ist unvollständig – bitte ergänzen Sie Eigenschaft, Vergleicher und Wert.",
      "match-description-label": "Spielbeschreibung",
      "match-description-placeholder": "z.B. Der Nutzer stellt Fragen zu rechtlichen Themen, Verträgen oder Compliance.",
      "match-description-help": "Beschreiben Sie die Situation, in der diese Regel angewendet werden soll. Ihr LLM wird dies bewerten, um zu bestimmen, ob die Regel verwendet werden soll.",
      "route-to-label": "Pfad zum Anbieter und zum Modell",
      "route-to-description": "Wenn diese Regel zutrifft, verwenden Sie diesen Anbieter/dieses Modell.",
      "cancel": "Abbrechen",
      "saving": "Sparen...",
      ...
      "type-calculated-description": "Vergleichen Sie Nachrichten anhand von Eigenschaften wie Inhalt, Anzahl der Token oder Tageszeit.",
      "type-llm-label": "Klassifizierte LLM-Modelle",
      "type-llm-description": "Nutzen Sie ein LLM (Large Language Model), um die Nachricht basierend auf einer von Ihnen bereitgestellten Beschreibung zu klassifizieren.",
      ...
      "help-contains": "Liste, getrennt durch Kommas – entspricht, wenn die Eingabe einen der Werte (Groß- und Kleinschreibung wird ignoriert) enthält.",
      "help-matches": "Regex-Muster. Verwenden Sie `/muster/Flags`, um die Groß- und Kleinschreibung zu berücksichtigen (Standard ist keine Berücksichtigung).",
      "bool-true": "Richtig",
      "bool-false": "Falsch"
    },
    "provider-picker": {
      ...
      "setup-credentials": "Geben Sie die erforderlichen Anmeldeinformationen ein, um {{name}} als Ziel für die Weiterleitung zu verwenden.",
      "cancel": "Abbrechen",
    ...
    "router-selection": {
      ...
      "no-routers-link": "Erstellen Sie eine in den Einstellungen des Modellerouter",
      "model-router-label": "Modell-Router",
      "select-router": "Wählen Sie einen Router aus.",
      "select-description": "Wählen Sie den Router, den Sie für diesen Arbeitsbereich verwenden möchten.",
      "no-routers-chat": "Keine Router konfiguriert. Erstellen Sie einen im Menü \"Einstellungen > KI-Anbieter > Modell-Router\".",
    ...
    "chat": {
      ...
      "routed-to-rule": "Weitergeleitet über <route>{{model}}</route> nach <rule>{{ruleTitle}}</rule>"
    }
  },
  "defaultSystemPrompt": {
    "title": null,
