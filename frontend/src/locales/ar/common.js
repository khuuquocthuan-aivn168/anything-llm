...
const TRANSLATIONS = {
  ...
  "agent": {
    ...
    "settings": {
      ...
      "clarifying-questions": {
        ...
        "description": "عند تفعيلها، يمكن للوكلاء التوقف للتحقق من أي أسئلة توضيحية قصيرة إذا كان طلبك غامضًا.",
        "max-per-turn": {
          "title": "الحد الأقصى لعدد الأسئلة في كل دور",
          "description": "كم عدد الأسئلة التوضيحية التي يمكن للممثل طرحها في استبيان واحد؟"
        }
      }
    }
  },
  ...
  "chat_window": {
    ...
    "memories": {
      "title": "ذكريات",
      "empty": "حتى الآن، لا توجد ذكريات. بعد التفاعل مع برنامج الدردشة، ستتراكم المزيد من الذكريات.",
      "empty_cta": "إنشاء ذاكرة جديدة",
      "tab_workspace": "مساحة العمل",
      "tab_global": "عالمي",
      "toggle": {
        "label": "تمكين التخصيص",
        "description": "اسمح لمساعدك بالرجوع إلى معلومات حولك أو عن هذا المكان، واستخدام هذه المعلومات في المحادثات."
      },
      "auto_extraction": {
        "label": "ذكريات آلية",
      ...
      "modal": {
        ...
        "create_description": "يجب أن تكون الذكريات عبارة عن جملة واحدة وموجزة. على سبيل المثال: \"يفضل المستخدم لغة بايثون على لغة جافاسكربت\".",
        "edit_description": "قم بتحديث محتوى هذه الذاكرة.",
        "label": "الذاكرة",
        "placeholder": "على سبيل المثال: اسم المستخدم هو \"جو\"، المستخدم يعمل على برنامج \"AnythingLLM\"، إلخ.",
        "create": "إنشاء",
        "save": "احفظ",
        "cancel": "إلغاء"
      }
    ...
    "stt_mic_denied": "لم يتمكن من الوصول إلى الميكروفون. يرجى منح الإذن ومحاولة مرة أخرى.",
  ...
  "model-router": {
    ...
    "description": "تتيح لك أجهزة التوجيه المخصصة تحديد قواعد لتوجيه رسائل الدردشة تلقائيًا إلى مزودي ونماذج LLM المختلفة بناءً على شروط معينة.",
    "table": {
      "name": "الاسم",
    ...
    "empty-description": "لم يتم تكوين أي من أجهزة التوجيه بعد. قم بإنشاء واحد للبدء.",
    "new-router-button": "جهاز توجيه جديد",
    "delete-confirm": "هل أنت متأكد من أنك تريد حذف جهاز التوجيه \"{{name}}\"؟\nسيؤدي ذلك إلى إزالة جميع قواعده وقطع الاتصال بأي مساح عمل تستخدمه.\n\nهذا الإجراء غير قابل للتراجع.",
    ...
    "new-router": {
      ...
      "fallback-description": "يُستخدم عندما لا تتطابق أي قاعدة مسار. كما يُستخدم أيضًا لتقييم القواعد التي تم تصنيفها بواسطة نموذج لغوي كبير.",
      "cooldown-label": "فترة التبريد (بالثواني)",
      "cooldown-help": "كم من الوقت يتم تخزين قرار التوجيه قبل إعادة تقييم القواعد؟ اضبط القيمة على 0 لتعطيل التخزين.",
    ...
    "rules": {
      ...
      "description": "حدد القواعد التي تحدد متى وكيف يتم إرسال رسائل الدردشة إلى مزودي الخدمات والنماذج المحددة.",
      ...
      "empty-description": "أضف قاعدة لتوجيه رسائل الدردشة إلى مزودي خدمات وموديلات محددة.",
      "new-rule-button": "قاعدة جديدة",
      "calculated-section-label": "القواعد المحسوبة – يتم تقييمها أولاً، بترتيب الأولوية.",
      "llm-section-label": "قواعد LLM - يتم تقييمها كمجموعة إذا لم تتطابق أي من القواعد المحسوبة",
      "llm-rule-body": "قم بمطابقة <desc>\"{{description}}\"</desc> ثم انتقل إلى <route>{{route}}</route>",
      "calculated-no-conditions": "بدون شروط — الطريق إلى <route>{{route}}</route>",
      "calculated-single-condition": "إذا كانت <prop>{{property}}</prop> {{comparator}} <val>\"{{value}}\"</val>، فقم بتوجيهها إلى <route>{{route}}</route>",
      "calculated-multi-condition": "إذا كان {{quantifier}} من <cond>، فإن المسار يجب أن يكون إلى <route>، {{route}}، </route>",
    ...
    "rule-form": {
      ...
      "conditions-incomplete": "الشرط {{index}} غير مكتمل – يرجى إدخال معلومات عن الخاصية والمقارن والقيمة.",
      "match-description-label": "وصف المباراة",
      "match-description-placeholder": "على سبيل المثال، المستخدم يسأل عن قضايا قانونية، أو العقود، أو الامتثال للقوانين.",
      "match-description-help": "صف الموقف الذي تريد فيه تطبيق هذه القاعدة. يتم تقييم ذلك بواسطة نموذج اللغة الكبير (LLM) الخاص بك لتحديد ما إذا كان يجب استخدامه أم لا.",
      "route-to-label": "طريق الوصول إلى المورد ونموذج العمل",
      "route-to-description": "عندما يتطابق هذا القانون، استخدم هذا المزود/النموذج.",
      "cancel": "إلغاء",
      "saving": "حفظ...",
      ...
      "type-calculated-description": "ابحث عن التطابقات بناءً على خصائص الرسالة مثل المحتوى، أو عدد الرموز، أو وقت اليوم.",
      "type-llm-label": "تصنيف نموذج اللغة الكبير",
      "type-llm-description": "استخدم نموذج لغوي كبير لتصنيف الرسالة بناءً على الوصف الذي تقدمه.",
      ...
      "placeholder-between-hour": "على سبيل المثال: 9:17 (من الساعة 9 صباحًا إلى 5 مساءً)",
      ...
      "help-contains": "قائمة مفصولة بفواصل — تطابق إذا احتوى السؤال على أي من القيم (مع تجاهل حالة الأحرف).",
      "help-matches": "نمط التعابير النمطية. استخدم `/pattern/ مع العلامات للتحكم في حساسية الحالة (القيمة الافتراضية هي عدم الحساسية للحالة).",
      "bool-true": "صحيح",
      "bool-false": "خاطئ"
    },
    "provider-picker": {
      ...
      "setup-credentials": "أدخل بيانات الاعتماد المطلوبة لاستخدام {{name}} كوجهة توجيه.",
      "cancel": "إلغاء",
    ...
    "router-selection": {
      ...
      "no-routers-prefix-settings": "لم يتم تكوين أي من أجهزة التوجيه (routers) بعد.",
      ...
      "select-description": "اختر جهاز التوجيه الذي ستستخدمه لهذا الموقف العملي.",
      "no-routers-chat": "لا توجد أجهزة توجيه مُكوّنة. قم بإنشاء واحدة في قسم \"إعدادات\" > \"مقدمو الخدمات\" > \"جهاز توجيه النموذج\".",
    ...
    "chat": {
      ...
      "routed-to-rule": "تم توجيهه إلى <route>{{model}}</route> عبر <rule>{{ruleTitle}}</rule>"
    }
  },
  "defaultSystemPrompt": {
    "title": null,
