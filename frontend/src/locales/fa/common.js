...
const TRANSLATIONS = {
  ...
  "agent": {
    ...
    "settings": {
      ...
      "clarifying-questions": {
        ...
        "description": "هنگامی که این ویژگی فعال باشد، عوامل می‌توانند مکث کنند و در صورت ابهام در درخواست شما، سوالات کوتاه و توضیحی را بپرسند.",
        "max-per-turn": {
          "title": "حداکثر تعداد سوال در هر دور",
          "description": "مبلغ سوالات توضیحی که یک کارشناس ممکن است در یک نظرسنجی واحد بپرسد، چقدر است؟"
        }
      }
    }
  },
  ...
  "chat_window": {
    ...
    "memories": {
      "title": "یادها",
      "empty": "تا به امروز، هیچ خاطره‌ای ثبت نشده است. با استفاده بیشتر از چت‌بات، خاطرات جدیدی شکل خواهند گرفت.",
      "empty_cta": "ایجاد یک حافظه جدید",
      "tab_workspace": "فضای کاری",
      "tab_global": "جهانی",
      "toggle": {
        "label": "فعال کردن شخصی‌سازی",
        "description": "به دستیار خود اجازه دهید اطلاعاتی را در مورد شما یا این محیط کاری به یاد آورد و از این اطلاعات در گفتگوها استفاده کند."
      },
      "auto_extraction": {
        "label": "یادهای خودکار",
        "description": "از دستیار خود بخواهید به صورت خودکار خاطرات را ذخیره کند."
      },
      "menu": {
        "edit": "ویرایش",
        "delete": "حذف",
      ...
      "modal": {
        ...
        "create_description": "آیا خاطرات باید به صورت یک جمله مختصر و واضح بیان شوند؟ به عنوان مثال: \"کاربر ترجیح می‌دهد از پایتون به جای جاوا اسکریپت استفاده کند.\"",
        "edit_description": "محتوای این حافظه را به‌روزرسانی کنید.",
        "label": "حافظه",
        "placeholder": "به عنوان مثال، نام کاربر \"جو\" است، کاربر در \"AnythingLLM\" کار می‌کند و غیره.",
        "create": "ایجاد",
        "save": "ذخیره",
        "cancel": "لغو کردن"
      }
    ...
    "stt_mic_denied": "امکان دسترسی به میکروفون وجود نداشت. لطفاً اجازه دسترسی را بدهید و دوباره امتحان کنید.",
  ...
  "model-router": {
    "title": "روترهای مدل",
    "description": "روترهای مدل‌سازی به شما این امکان را می‌دهند که قوانین را برای مسیریابی خودکار پیام‌های چت به ارائه دهندگان و مدل‌های مختلف LLM، بر اساس شرایط، تعریف کنید.",
    "table": {
      "name": "نام",
    ...
    "empty-description": "هنوز هیچ روتر مدلی پیکربندی نشده است. برای شروع، یکی از آن‌ها را ایجاد کنید.",
    "new-router-button": "روتر جدید",
    "delete-confirm": "آیا مطمئن هستید که می‌خواهید روتر \"{{name}}\" را حذف کنید؟\nاین کار تمام تنظیمات و ارتباطات آن را حذف کرده و هر فضای کاری که از آن استفاده می‌کند را از بین می‌برد.\n\nاین عمل غیرقابل بازگشت است.",
    ...
    "new-router": {
      ...
      "fallback-description": "از زمانی استفاده می‌شود که هیچ قانون مسیریابی با شرایط موجود مطابقت نداشته باشد. همچنین برای ارزیابی قوانین طبقه‌بندی شده توسط مدل‌های زبان بزرگ (LLM) نیز استفاده می‌شود.",
      "cooldown-label": "مدت زمان انقضا (ثانیه)",
      "cooldown-help": "مدت زمانی که تصمیم‌گیری مسیریابی پس از بررسی مجدد قوانین ذخیره می‌شود. برای غیرفعال کردن ذخیره‌سازی، این مقدار را روی 0 تنظیم کنید.",
    ...
    "rules": {
      ...
      "description": "قواعدی را مشخص کنید که تعیین می‌کنند پیام‌های چت به چه ارائه دهندگان و مدل‌هایی ارسال می‌شوند و در چه زمان و نحوی.",
      ...
      "empty-description": "یک قانون را اضافه کنید تا پیام‌های چت را به صورت خاص به ارائه دهندگان و مدل‌های مشخص هدایت کند.",
      "new-rule-button": "قانون جدید",
      "calculated-section-label": "قواعد محاسبه‌شده - ابتدا، با اولویت‌بندی",
      "llm-section-label": "قوانین LLM — در صورتی که هیچ یک از قوانین محاسبه شده با داده‌های موجود مطابقت نداشته باشند، به صورت یک دسته ارزیابی می‌شوند.",
      "llm-rule-body": "مطابقت با <desc>\"{{description}}\"</desc>، سپس مسیریابی به <route>{{route}}</route>",
      "calculated-no-conditions": "بدون هیچ شرط – مسیر به سمت <route>{{route}}</route>",
      "calculated-single-condition": "اگر <prop>، {{property}}، </prop>، {{comparator}}، <val>، \"{{value}}\"، </val> باشد، مسیر را به <route>، {{route}}، </route> تعیین کنید.",
      "calculated-multi-condition": "اگر {{quantifier}} از نوع <cond> باشد، مسیر را به <route>{{route}}</route> تغییر دهید.",
      ...
      "aria-drag-to-reorder": "برای تغییر ترتیب، این عناصر را بکشید و رها کنید.",
    ...
    "rule-form": {
      ...
      "conditions-incomplete": "شرط {{index}} ناقص است – لطفاً اطلاعات مربوط به ویژگی، مقایسه و مقدار را پر کنید.",
      "match-description-label": "توضیحات مسابقه",
      "match-description-placeholder": "به عنوان مثال، کاربر در مورد موضوعات حقوقی، قراردادها یا رعایت قوانین سوال می کند.",
      "match-description-help": "وضعیتی را توصیف کنید که در آن می‌خواهید این قانون اعمال شود. مدل زبانی شما این را ارزیابی می‌کند تا مشخص کند آیا باید از این قانون استفاده شود یا خیر.",
      "route-to-label": "مسیر به سمت ارائه خدمات و مدل",
      "route-to-description": "زمانی که این قانون اعمال شود، از این ارائه‌دهنده/مدل استفاده کنید.",
      "cancel": "لغو کردن",
      "saving": "ذخیره...",
      ...
      "type-calculated-description": "براساس ویژگی‌های پیام مانند محتوا، تعداد توکن‌ها، یا زمان روز، تطابق را انجام دهید.",
      "type-llm-label": "دسته‌بندی مدل‌های زبانی بزرگ",
      "type-llm-description": "از یک مدل زبان بزرگ (LLM) برای دسته‌بندی پیام بر اساس توضیحی که ارائه می‌دهید، استفاده کنید.",
      ...
      "placeholder-between-hour": "به عنوان مثال، 9 تا 17 (از ساعت 9 صبح تا 5 بعد از ظهر)",
      ...
      "help-contains": "لیست جدا شده با کاما - تطابق زمانی که متن ورودی شامل هر یک از مقادیر (بدون در نظر گرفتن حروف بزرگ و کوچک) باشد.",
      "help-matches": "الگو (Regex). برای تشخیص حساسیت به حروف بزرگ و کوچک، از عبارت `/pattern/flags` استفاده کنید (به طور پیش‌فرض، تشخیص حساسیت به حروف بزرگ و کوچک غیرفعال است).",
      "bool-true": "درست",
      "bool-false": "غلط"
    },
    "provider-picker": {
      ...
      "setup-credentials": "برای استفاده از {{name}} به عنوان مقصد، اطلاعات مورد نیاز را وارد کنید.",
      "cancel": "لغو کردن",
    ...
    "router-selection": {
      ...
      "select-description": "انتخاب کنید که کدام روتر برای این محیط کاری باید استفاده شود.",
      "no-routers-chat": "هیچ روتر تنظیم نشده است. یک روتر را در قسمت تنظیمات > ارائه دهندگان هوش مصنوعی > روتر مدل ایجاد کنید.",
    ...
    "chat": {
      ...
      "routed-to-rule": "به <route>{{model}}</route> از طریق <rule>{{ruleTitle}}</rule> ارسال شد."
    }
  },
  "defaultSystemPrompt": {
    "title": null,
